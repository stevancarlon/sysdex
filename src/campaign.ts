...
export const campaignPhases: CampaignPhase[] = [
  ...
  },
  {
    ...
    difficulty: "Operator",
    workload: "analytics",
    objective: "Scale a social redirect service without slowing user traffic.",
    description: "Traffic has doubled and analytics work is competing with user requests.",
    lesson: "Use caching and asynchronous work to remove slow dependencies from the hot path.",
    targetRps: 1_200,
    latencySlo: 115,
    errorSlo: 1.5,
    budget: 1_790,
